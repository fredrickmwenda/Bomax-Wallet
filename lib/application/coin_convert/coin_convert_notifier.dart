...
import 'package:bodax_wallet/domain/coin_failure.dart';
import 'package:bodax_wallet/domain/i_coin_repository.dart';
...
class CoinConvertNotifier extends StateNotifier<CoinConvertState> {
  ...
  void validate() {
    ...
    // Valido que la cantidad a converter para saber si paso o no a la pantalla
    // de confirmacion
