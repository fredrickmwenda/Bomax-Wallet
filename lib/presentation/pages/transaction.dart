...
import 'package:bodax_wallet/presentation/core/models/transaction_model.dart';
...
// Widget listPriceGainers(transactions item, BuildContext ctx) {
//   return Padding(
...
Widget loadingListPriceGainers(transactions item, BuildContext ctx) {
  return Padding(
...
Widget _loadingImageAnimation(BuildContext context) {
  return Container(
    child: ListView.builder(
      ...
      itemBuilder: (ctx, i) {
        return loadingListPriceGainers(transactionsList[i], ctx);
      },
    ),
  );
}
