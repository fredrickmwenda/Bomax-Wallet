...
import 'package:bodax_wallet/presentation/core/widgets/coin_card.dart';
import 'package:bodax_wallet/presentation/core/widgets/critical_failure.dart';
...
class __SuccessContentState extends State<_SuccessContent> {
  final _color = const Color(0xDA000000);
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: AnimatedCrossFade(
            ...
            firstChild: Text('Portfolio Value',
                maxLines: 1,
                textAlign: TextAlign.center,
                style: TextStyle(
                    color: Colors.white,
